...
function UserForm() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:5000/api/generate-topics', userData);
      ...
      <section className="bg-gray-100">
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
          <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
            <img
              alt=""
              src="https://tonbofa.com/home/wp-content/uploads/2020/08/fintech2-1024x629-1.jpg"
        ...
        <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-6 gap-6">
          <div className="col-span-6 sm:col-span-3 mb-4">
            ...
            <input
              ...
              className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm focus:ring-blue-500 focus:border-blue-500"
              required
            />
          </div>
          ...
          <div className="col-span-6">
            <label htmlFor="MarketingAccept" className="flex gap-4">
              <input
                ...
                checked={userData.marketingAccept}
                onChange={handleChange}
          ...
          <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
            <button
              type="submit"
              className="inline-block py-3 px-12 border border-blue-600 rounded-md bg-blue-600 text-white font-medium transition duration-300 hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring focus:ring-blue-200"
            >
              Next
            </button>
          </div>
